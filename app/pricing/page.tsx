        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-8 max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground text-pretty">
              Fair, transparent pricing powered by Verse Pay. Students contribute as little as ₦50 per session, while
      ...
      <section className="py-20 bg-muted/30 text-foreground">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center space-y-4 mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-balance">How Verse Pay Works</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Connect your Verse wallet to get started. No credit card required.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto space-y-8">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">Why use Verse Pay instead of traditional payments?</h3>
              <p className="text-muted-foreground">
                Verse Pay offers near-zero transaction fees, instant settlement, and global
      ...
      <footer className="border-t border-border bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center text-muted-foreground">
            <p>&copy; {new Date().getFullYear()} Gossiper. All rights reserved. Powered by Verse.</p>
          </div>
        </div>
      </footer>
    </div>
