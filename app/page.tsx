          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-border hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardTitle>Verse-Powered</CardTitle>
                <CardDescription>
                  Sustainable micro-payments via Verse Pay. Students contribute as little as ₦50 ($0.10).
                </CardDescription>
              </CardHeader>
            </Card>
            <Card className="border-border hover:shadow-lg transition-shadow">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          ...
          <div className="border-t border-border mt-8 sm:mt-12 pt-6 sm:pt-8 text-center">
            <p className="text-xs sm:text-sm text-muted-foreground">
              &copy; {new Date().getFullYear()} Gossiper. All rights reserved. Powered by Verse.
            </p>
          </div>
        </div>
      </footer>
